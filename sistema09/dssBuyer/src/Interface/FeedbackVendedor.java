 ...
 * @author helder
 */
public class FeedbackVendedor extends javax.swing.JFrame {
    
    private dssBuyer dssBuyer;
    private Negocio negocio;

    /**
     * Creates new form FeedbackVendedor
     */
    public FeedbackVendedor(dssBuyer d, Negocio n) {
        this.dssBuyer = d;
        this.negocio = n;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Utilizador comprador = this.negocio.getComprador();
            if (this.positivo.isSelected()) {
                comprador.incrementaFeed();
            }
            else {
                comprador.decrementaFeed();
            }
            this.negocio.setFeedVendedor(this.jTextArea1.getText());
            this.dssBuyer.atualizaNegocio(this.negocio);
            this.dssBuyer.actualizaUtilizador(comprador);
